...
const items = [
  ...
  { label: 'Entries', to: '/entries', match: ['/entries', '/entries/create'], icon: 'M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01' },
  { label: 'Invoices', to: '/dutyslips', match: ['/dutyslips', '/dutyslips/create'], dynamic: /^\/dutyslips\/[^/]+$/, icon: 'M7 3h7l5 5v13H7zM14 3v5h5M9 13h6M9 17h6' },
