    ...
    <div>
        ...
        <div class="mb-10">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <router-link to="/dutyslips/create"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <div class="space-y-2">
                    <router-link v-for="slip in recentSlips" :key="slip.id" :to="`/dutyslips/${slip.id}`"
                    ...
                    <div v-for="entry in recentEntries" :key="entry.id"
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-xs font-mono mt-0.5">
                                <span v-if="entry.duty_slip" class="text-green-500">assigned</span>
