...
class DutySlip(models.Model):
    ...
    slip_type = models.CharField(max_length=20, choices=SLIP_TYPE_CHOICES, default='regular')
...
class CompanyCarRate(models.Model):
    ...
    outstation_rate = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
